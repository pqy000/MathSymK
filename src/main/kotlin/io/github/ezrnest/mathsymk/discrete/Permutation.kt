...
import io.github.ezrnest.mathsymk.function.BijectiveOperator
import io.github.ezrnest.mathsymk.model.struct.Composable
...
//    fun fromPermuted(origin: )
        ...
        fun getCalculator(size: Int): Group<Permutation> {
            return PermutationGroup(size)
        }

        private class PermutationGroup(
            val size: Int,
            override val identity: Permutation = identity(size)
        ) : Group<Permutation> {

//            override val numberClass: Class<Permutation>
