...
//    }
     ...
     */
    /**
     * Returns the number of partitions of the number `n`. A partition is a set of integers
     * and their sum is equal to `n`.
     *
     *
     * For example, 4=4=1+3=2+2=1+1+2=1+1+1+1, so there are 5 different partitions and
     * `integerPartition(4)=5`. By convenience,
     * if `n==0`, this method will return `1` and if `n<0`, `0` will be returned.
     *
     * @param n an integer
     * @return the number of partitions
     */
